...
\begin{frame}{Quantum Target Ranging (QTR)}
	...
	\begin{columns}[T]
		...
		\centering
		\includegraphics[width=0.95\textwidth]{immagini/DisegninoRangingPresentazione.png}
...
\begin{frame}{Setup sperimentale}
	\begin{tikzpicture}
		...
		\pause
		\node (B) at (-4.2,1)
		{\includegraphics[width=0.45\textwidth]{immagini/FotoSetupSinistra.jpeg}};
		
		
		\node (C) at (0,1.1)
		{\includegraphics[width=0.45\textwidth]{immagini/FotoSetupDestra.jpeg}};
		
		
		\node (D) at (5.2,1.2)
		{\includegraphics[width=0.3\textwidth]{immagini/FotoSNSPD.jpeg}};
...
SNSPD salvano il tempo di arrivo dei fotoni inserendolo .\\
\vspace{0.35cm}
{
\centering
