...
\begin{frame}{Quantum Target Detection (QTD)}
	...
	\begin{columns}[T]
		...
		\begin{itemize}
			\item \textbf{Probe:} stato $\rho_T$ con numero medio di fotoni $\mu_0 \ll 1$
			\item \textbf{Background:} stato $\rho_B$ con numero medio $\mu_B \gg 1$
			\item \textbf{Target:} riflettività $k \ll 1$
		\end{itemize}
				
		\vspace{0.25cm}
		AAAAAAAAAAAAHHHHH QUANTUM ILLUMINATIONNN!!!!!
		...
		\column{0.45\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{immagini/DisegninoDetection.png}
...
\begin{frame}{Quantum Target Detection (QTD)}
	\begin{columns}[T]
		...
		Canale $\mathcal{E}_{k,\mu_B}$ agisce indipendentemente su ogni copia.\\
		...
		\column{0.45\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{immagini/DisegninoDetectionTensorL.png}
	\end{columns}
...
I conteggi degli SNSPD vengono salvati in stringhe in base al tempo di arrivo.\\
\vspace{0.35cm}
{
\centering
\includegraphics[width=1\textwidth]{immagini/StringsCorrelationPicture.png}
\par}
Le stringhe vengono shiftate fino a trovare il picco del coefficiente di Pearson, $C = \frac{\sigma_{XY}}{\sigma_X\sigma_Y}$.
...
\begin{frame}{Analisi dati}
Il picco è inizialmente individuato quando il rumore è assente.\\
La posizione individuata è la posizione vera del picco.\\
\begin{equation*}
	p_{err, \ exp} = \frac{1-err}{total}
\end{equation*}
\begin{columns}
...
\begin{frame}{Risultati}
    ...
    \includegraphics[width=0.3\textwidth]{immagini/QCher_VS_muB_16-01-26_QvsC.png}
    \includegraphics[width=0.3\textwidth]{immagini/errProb_VS_muB_16-01-26_QvsC.png}
\end{frame}
